(function () {
    ...
    SubscriptionManagementOperationsOffersModule.config(function ($stateProvider) {
        ...
        $stateProvider.state('subsystems.subscriptionmanagement.operations.offers', {
        ...
        }).state('subsystems.subscriptionmanagement.operations.offers.new', {
            url: "/new",
        ...
        }).state('subsystems.subscriptionmanagement.operations.offers.update', {
            url: "/update/:id",
            templateUrl: "subsystems/subscriptionmanagement/operations/offers/operations.offers.detail.html",
            ...
            resolve: {
                ...
                offer: function ($stateParams, CMPFService) {
                    ...
                    return CMPFService.getOffer(offerId);
                },
                offers: function (CMPFService, DEFAULT_REST_QUERY_LIMIT) {
                    return CMPFService.getOffers(0, DEFAULT_REST_QUERY_LIMIT, true, false);
                }
    ...
    SubscriptionManagementOperationsOffersModule.controller('ProvisioningOperationsCommonCtrl', function ($scope, $log, $controller, $state, $filter, $uibModal, notification, $translate, UtilService,
        ...
        $scope.addI18NText = function (entityi18nProfiles) {
            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/subscriptionmanagement/operations/offers/operations.offers.new.modal.i18n.html',
        ...
        $scope.addShortcodeAndKeyword = function (shortcodeAndKeywords) {
            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/subscriptionmanagement/operations/offers/operations.offers.new.modal.shortcodeandkeyword.html',
            ...
            var modalInstance = $uibModal.open({
                ...
                resolve: {
                    ...
                    offersModalTitleKey: function () {
                        return 'Subsystems.SubscriptionManagement.Operations.Offers.XsmTrial.NextOfferModalTitle';
                    }
                }
            });
    ...
    SubscriptionManagementOperationsOffersModule.controller('ProvisioningOperationsOffersCtrl', function ($scope, $log, $uibModal, $filter, $translate, notification, NgTableParams, NgTableService,
        ...
        $scope.viewServices = function (offer) {
            offer.rowSelected = true;

            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/subscriptionmanagement/operations/offers/operations.offers.modal.viewservices.html',
    ...
    SubscriptionManagementOperationsOffersModule.controller('ProvisioningOperationsNewOfferCtrl', function ($scope, $log, $state, $controller, $filter, $uibModal, $translate, notification, Restangular, UtilService,
        ...
        $scope.offer = {
            ...
            xsmChargingProfile: {
                ...
                MicroChargingEnabledAtRenewals: true,
                MicroPrice: 0,
                MaxRetryCount: 60,
                MaxFailedChargingAttemptCount: 0,
                ChargingPolicy: 'Immediate',
                MicroChargingEnabledAtTrialEnd: true,
                InitialChargingRetryEnabled: true,
                InitialChargingPolicy: 'ChargingOnAttempt',
                MicroChargingEnabledAtInitialSubscription: true,
        ...
        $scope.save = function (offer) {
            if (!$scope.selectedOperator.name) {
                notification({
                    type: 'warning',
                    text: $translate.instant('Subsystems.SubscriptionManagement.Operations.Offers.Messages.SelectOrganization')
                });
            ...
            if (!$scope.selectedServices.length) {
                notification({
                    type: 'warning',
                    text: $translate.instant('Subsystems.SubscriptionManagement.Operations.Offers.Messages.SelectService')
                });
    ...
    SubscriptionManagementOperationsOffersModule.controller('ProvisioningOperationsUpdateOfferCtrl', function ($scope, $state, $log, $controller, $filter, $timeout, $q, notification, $translate, $uibModal, Restangular,
        ...
        if ($scope.offer.xsmTrialProfile) {
            ...
            $scope.offer.xsmTrialProfile = {
                TryAndBuyEnabled: false,
                TrialPeriod: {duration: 1, unit: 'Days'}
            }
        }
        ...
        $scope.save = function (offer) {
            ...
            var offerObj = {
                ...
                profiles: $scope.originalOffer.profiles ? $scope.originalOffer.profiles : []
            };

            // Entityi18nProfiles
            if ($scope.entityi18nProfiles && $scope.entityi18nProfiles.length > 0) {
                // Filter out the removed items from the list.
                offerObj.profiles = _.filter(offerObj.profiles, function (originalEntityi18nProfile) {
                    if (originalEntityi18nProfile.name === CMPFService.ENTITY_I18N_PROFILE) {
                        return _.findWhere($scope.entityi18nProfiles, {profileId: originalEntityi18nProfile.id});
                    } else {
                        return true;
                    }
                });
                ...
                _.each($scope.entityi18nProfiles, function (updatedEntityi18nProfile) {
                    ...
                    delete updatedEntityi18nProfile.id;

                    var originalEntityi18nProfile = _.findWhere(originalEntityi18nProfiles, {id: updatedEntityi18nProfile.profileId});
                    var entityi18nProfilesAttrArray = CMPFService.prepareProfile(updatedEntityi18nProfile, originalEntityi18nProfile);
                    // ---
                    if (originalEntityi18nProfile) {
                        originalEntityi18nProfile.attributes = entityi18nProfilesAttrArray;
                    } else {
                        var entityi18nProfiles = {
                            name: CMPFService.ENTITY_I18N_PROFILE,
                            profileDefinitionName: CMPFService.ENTITY_I18N_PROFILE,
                            attributes: entityi18nProfilesAttrArray
                        };

                        offerObj.profiles.push(entityi18nProfiles);
                    }
                });
            } else {
                // Remove Entityi18nProfiles instances
                offerObj.profiles = _.filter(offerObj.profiles, function (profile) {
                    return profile.profileDefinitionName !== CMPFService.ENTITY_I18N_PROFILE;
                });
            }
            ...
            if (offer.xsmTrialProfile) {
                ...
                if (offer.xsmTrialProfile.TrialPeriod) {
                    offer.xsmTrialProfile.TrialPeriod.toJSON = function () {
                        return UtilService.convertSimpleObjectToPeriod(this);
                    };
                }
                if (offer.xsmTrialProfile.NotificationEventDuration) {
    ...
    SubscriptionManagementOperationsOffersModule.controller('OffersOwnServicesModalInstanceCtrl', function ($scope, $uibModalInstance, $log, $filter, NgTableParams, NgTableService, Restangular,
    ...
    SubscriptionManagementOperationsOffersModule.controller('OfferServicesModalInstanceCtrl', function ($scope, $uibModalInstance, $log, $filter, NgTableParams, NgTableService, Restangular,
