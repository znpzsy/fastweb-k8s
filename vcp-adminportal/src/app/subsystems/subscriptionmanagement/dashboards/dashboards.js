(function () {
    ...
    SubscriptionManagementDashboardsModule.controller('SubscriptionManagementSubscribersDashboardsCtrl', function ($scope, $log, Restangular,
                                                                                                                   promiseTracker) {
        /*
    ...
    SubscriptionManagementDashboardsModule.controller('SubscriptionManagementOffersDashboardsCtrl', function ($scope, $log, CMPFService, Restangular, PlotService, DEFAULT_REST_QUERY_LIMIT,
                                                                                                              promiseTracker) {
        CMPFService.getOffers(0, 0, true, false, promiseTracker).then(function (response) {
