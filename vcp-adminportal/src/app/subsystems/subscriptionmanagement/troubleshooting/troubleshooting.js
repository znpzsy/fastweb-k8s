(function () {
    ...
    SubscriptionManagementTroubleshootingModule.config(function ($stateProvider) {
        ...
        $stateProvider.state('subsystems.subscriptionmanagement.troubleshooting', {
            url: "/troubleshooting",
            templateUrl: "subsystems/subscriptionmanagement/troubleshooting/troubleshooting.html",
            controller: 'SubscriptionManagementTroubleshootingCtrl',
            data: {
                permissions: [
    ...
    SubscriptionManagementTroubleshootingModule.controller('SubscriptionManagementTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, Restangular, UtilService, DateTimeConstants,
        ...
        $controller('SubscriptionManagementTroubleshootingTableCtrl', {$scope: $scope});
        $controller('SubscriptionManagementTroubleshootingHistoryCtrl', {$scope: $scope});
    });

    SubscriptionManagementTroubleshootingModule.controller('SubscriptionManagementTroubleshootingTableCtrl', function ($scope, $log, $filter, $uibModal, UtilService, NgTableParams, notification, $translate,
    ...
    SubscriptionManagementTroubleshootingModule.controller('SubscriptionManagementTroubleshootingHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                                                         GeneralESService, DateTimeConstants) {
        $log.debug('SubscriptionManagementTroubleshootingHistoryCtrl');
