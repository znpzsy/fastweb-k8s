    ...
    ProvisioningUsersAccountsOperationsModule.controller('ProvisioningOperationsNewUserAccountCtrl', function ($scope, $state, $log, $uibModal, $timeout, $q, $controller, notification, $translate,
        ...
        $scope.save = function (userAccount) {
            var userAccountItem = {
                ...
                password: ($scope.userAccount.userProfile.ActiveDirectoryAuthentication ? CMPF_USER_KEYS[0] : userAccount.password),
            ...
            userAccountItem.profiles = [{
                "attributes": [
                    ...
                    {"name": "ActiveDirectoryAuthentication", "value": userAccount.userProfile.ActiveDirectoryAuthentication}
                ],
