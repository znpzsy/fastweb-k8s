(function () {
    ...
    ReportingReportsMMSCModule.controller('ReportingReportsMMSCCtrl', function ($scope, $log, $controller, $filter, UtilService, Restangular, CMPFService,
        ...
        var MMSC_MM3_Content_Type_Report = UtilService.defineReportsAsDHM(':home:vcp:MMSC:MMSC_MM3_Content_Type_Report.prpt');
        var MMSC_MM3_Message_Size_Categories_Report = UtilService.defineReportsAsDHM(':home:vcp:MMSC:MMSC_MM3_Message_Size_Categories_Report.prpt');
        ...
        $scope.REPORTS = [
            ...
            // MM3 - MMSC External Server Reports
            {
                ...
                label: 'MMS Center MM3 Incoming Traffic Report',
                intervals: MMSC_MM3_Incoming_Traffic_Report
            },
            {
                group: 'MMSC External Server Reports',
            ...
            {
                group: 'MMSC External Server Reports',
                label: 'MMS Center MM3 Content Type Report',
                intervals: MMSC_MM3_Content_Type_Report
            },
            {
                group: 'MMSC External Server Reports',
                label: 'MMS Center MM3 Message Size Categories Report',
                intervals: MMSC_MM3_Message_Size_Categories_Report
            },
            // MM4 - MMSC Interconnect Agents Reports
            {
