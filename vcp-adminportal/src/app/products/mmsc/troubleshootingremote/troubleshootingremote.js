(function () {
    ...
    angular.module('adminportal.products.mmsc.troubleshootingremote', []);

    var MmscTroubleshootingRemoteModule = angular.module('adminportal.products.mmsc.troubleshootingremote');

    MmscTroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('products.mmsc.troubleshootingremote', {
            abstract: true,
            url: "/troubleshooting-remote",
            templateUrl: "products/mmsc/troubleshooting/troubleshooting.html"
        }).state('products.mmsc.troubleshootingremote.edr', {
            abstract: true,
            url: "",
            templateUrl: 'products/mmsc/troubleshooting/troubleshooting.edr.html',
            controller: 'MmscTroubleshootingRemoteCtrl'
        }).state('products.mmsc.troubleshootingremote.edr.view', {
            url: "",
            views: {
                'permanentTable': {
    ...
    MmscTroubleshootingRemoteModule.controller('MmscTroubleshootingRemoteCtrl', function ($scope, $log, $q, $uibModal, $filter, $timeout, $controller, DateTimeConstants, GeneralESService) {
        $log.debug('MmscTroubleshootingRemoteCtrl');
        ...
        $controller('MmscTroubleshootingRemotePermanentCtrl', {$scope: $scope});
        $controller('MmscTroubleshootingRemoteTransientCtrl', {$scope: $scope});
        $controller('MmscTroubleshootingRemoteHistoryCtrl', {$scope: $scope});
        $controller('MmscTroubleshootingRemoteSummarizeCtrl', {$scope: $scope});
    });

    MmscTroubleshootingRemoteModule.controller('MmscTroubleshootingRemotePermanentCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants,
                                                                                                   ReportingExportService, UtilService, GeneralESService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION) {
        $log.debug('MmscTroubleshootingRemotePermanentCtrl');
    ...
    MmscTroubleshootingRemoteModule.controller('MmscTroubleshootingRemoteTransientCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, UtilService, DateTimeConstants,
                                                                                                   ReportingExportService, GeneralESService, MmscTroubleshootingService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION) {
        $log.debug('MmscTroubleshootingRemoteTransientCtrl');
        ...
        $scope.mmscTransientEdrList.tableParams = new NgTableParams({
            ...
            getData: function ($defer, params) {
                ...
                if (params.settings().$scope.askService) {
                    GeneralESService.findMmscTransientEdrsRemote(filter, additionalFilterFields).then(function (response) {
        ...
        $scope.showMessageContent = function (edrRecord) {
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, contentIdList) {
                    $scope.restServicePath = '/mmsc-troubleshooting-remote-rest/v2';
                    $scope.edrRecord = edrRecord;
    ...
    MmscTroubleshootingRemoteModule.controller('MmscTroubleshootingRemoteHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants) {
        $log.debug('MmscTroubleshootingRemoteHistoryCtrl');
    ...
    MmscTroubleshootingRemoteModule.controller('MmscTroubleshootingRemoteSummarizeCtrl', function ($scope, $log) {
        $log.debug('MmscTroubleshootingRemoteSummarizeCtrl');
