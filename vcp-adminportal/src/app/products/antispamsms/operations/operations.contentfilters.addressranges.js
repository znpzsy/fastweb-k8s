(function () {
    ...
    angular.module('adminportal.products.antispamsms.operations.contentfilters.addressranges', []);

    var AntiSpamSMSOperationsContentFiltersAddressRangesModule = angular.module('adminportal.products.antispamsms.operations.contentfilters.addressranges');

    AntiSpamSMSOperationsContentFiltersAddressRangesModule.controller('AntiSpamSMSOperationsContentFiltersAddressRangesCtrl', function ($scope, $uibModalInstance, $log, $filter, $uibModal, $translate, notification, NgTableParams, NgTableService,
        ...
        $log.debug("AntiSpamSMSOperationsContentFiltersAddressRangesCtrl");

        addressRanges = addressRanges ? addressRanges : [];

        $scope.contentFiltersEntryName = contentFiltersEntry.name;
        ...
        $scope.addNewAddressRange = function (addressRange) {
            ...
            SMSAntiSpamConfigService.createContentFiltersEntryRange(direction, participant, $scope.contentFiltersEntryName, addressRangeItem).then(function (response) {
        ...
        $scope.removeAddressRange = function (addressRangeItem) {
            ...
            modalInstance.result.then(function () {
                ...
                SMSAntiSpamConfigService.deleteContentFiltersEntryRange(direction, participant, $scope.contentFiltersEntryName, addressRangeItem.name).then(function (response) {
