(function () {
    ...
    angular.module('adminportal.products.antispamsms.troubleshooting', []);

    var AntiSpamSMSTroubleshootingModule = angular.module('adminportal.products.antispamsms.troubleshooting');
    ...
    AntiSpamSMSTroubleshootingModule.controller('AntiSpamSMSTroubleshootingCtrl', function ($scope, $log, $q, $filter, $controller, $timeout, notification, $translate, $uibModal, NgTableParams, ReportingExportService,
        ...
        $scope.throttledReloadTable = _.throttle(function () {
            $scope.reloadTable($scope.edrList.tableParams, true);
        }, 500);
        ...
        var exportEdrs = function (mimeType) {
            ...
            var srcUrl = '/smsantispam-es-adapter-rest/elastic-search-adapter/sms-as/_export';
