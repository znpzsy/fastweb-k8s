(function () {
    ...
    // Use between 28th October - 27th March
    //var TIMEZONE = 'EET';
    // Use between 27th March - 28th October
    var TIMEZONE = 'EEST';
    ...
    ApplicationConstants.constant('P4M_MVNO_NAME', 'VIL');
    ...
    ApplicationConstants.constant('CHARGING_FAILURE_POLICIES', [
        {key: 'ContinueWithDebt', label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmCharging.ContinueWithDebt'},
        {key: 'Terminate', label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmCharging.Terminate'}
    ]);

    ApplicationConstants.constant('CHARGING_HANDLERS', [
        {key: 'Suspended', label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmCharging.Suspended'},
        {key: 'Active', label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmCharging.Active'}
    ]);

    ApplicationConstants.constant('TERMINATION_POLICIES', [
        {
            key: 'ImmediateTermination',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmOffer.ImmediateTermination'
        },
        {
            key: 'DeferredTermination',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmOffer.DeferredTermination'
        }
    ]);
    ...
    ApplicationConstants.constant('RENEWAL_POLICIES', [
        {
            key: 'NoRenewal',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmRenewal.NoRenewal'
        },
        {
            key: 'AutoWithNotification',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmRenewal.AutoWithNotification'
        },
        {
            key: 'Auto',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmRenewal.Auto'
        }
    ]);
    ...
    ApplicationConstants.constant('TRIAL_POLICIES', [
        {
            ...
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmTrial.BuyWithConfirmation'
        },
        {
            key: 'AutoBuyWithNotification',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmTrial.AutoBuyWithNotification'
        },
        {
            key: 'AutoBuyWithoutNotification',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmTrial.AutoBuyWithoutNotification'
        },
        {
            key: 'EndWithoutNotification',
            label: 'Subsystems.SubscriptionManagement.Operations.Offers.XsmTrial.EndWithoutNotification'
        }
    ]);

    ApplicationConstants.constant('PAYMENT_TYPES', [
