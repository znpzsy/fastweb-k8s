(function () {
    ...
    ApplicationDirectives.directive('dontFill', function () {
        return {
            restrict: 'A',
    ...
    ApplicationDirectives.directive('submitButtonIndicator', function ($interval, cfpLoadingBar) {
        return {
            restrict: 'A',
            link: function (scope, element, attr) {
                ...
                element.on('click', function (event) {
                    ...
                    _interval = $interval(function () {
                        scope.$emit('SubmitButtonIndicatorChanged', cfpLoadingBar.status());
                    }, 2000);
                });

                scope.$on('SubmitButtonIndicatorChanged', function (event, indicatorValue) {
                    if (indicatorValue === 0) {
