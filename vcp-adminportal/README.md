# VAS Consolidation Administration Web Application
---
...
contains the content of it like this "vcp-adminportal-\<timestamp\>.tar.gz".
...
Please read the instructions that specified in A3GW product for portal proxy configurations.

If you have completed the A3GW proxy configurations then you can put the html5 boilerplate conf file under the configurations
directory of Apache Server.

Here is the project of the server configuration: https://github.com/h5bp/server-configs-apache

Create a configuration file named _html5-boilerplate.conf_ under the _/etc/httpd/conf.d_ directory. Copy the contents of this resource:
https://github.com/h5bp/server-configs-apache/blob/master/dist/.htaccess to that file. Restart the apache server:

_Please do below steps as root user_
<pre>
]# cd /etc/httpd/conf.d
]# wget https://raw.githubusercontent.com/h5bp/server-configs-apache/master/dist/.htaccess
]# mv .haccess html5-boilerplate.conf
