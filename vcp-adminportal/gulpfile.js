...
var applicationName = 'vcp-adminportal';
...
// Copy images.
gulp.task('copy-map-img', ['minify-view-htmls'], function () {
    return gulp.src(['bower_components/leaflet/dist/images/**/*', 'bower_components/leaflet-draw/dist/images/**/*']).pipe(gulp.dest(bases.dist + '/styles/images'));
});
...
gulp.task('copy', ['copy-map-img', 'copy-img', 'copy-i18n', 'copy-html5-js', 'copy-fonts', 'copy-htaccess']);
    ...
    return connect.server({
        ...
        middleware: function (connect) {
            return [
                ...
                connect().use('/adminportal/styles/images', serveStatic('bower_components/leaflet/dist/images')),
                connect().use('/adminportal/styles/images', serveStatic('bower_components/leaflet-draw/dist/images')),
