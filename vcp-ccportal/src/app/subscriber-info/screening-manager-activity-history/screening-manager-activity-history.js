(function () {
    ...
    angular.module('ccportal.subscriber-info.screening-manager-activity-history', []);

    var SIScreeningManagerActivityHistoryModule = angular.module('ccportal.subscriber-info.screening-manager-activity-history');

    SIScreeningManagerActivityHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('subscriber-info.screening-manager-activity-history', {
            url: "/screening-manager-activity-history",
            templateUrl: "subscriber-info/screening-manager-activity-history/screening-manager-activity-history.html",
            controller: 'SIScreeningManagerActivityActivityHistoryCtrl',
            resolve: {}
        });

    });

    SIScreeningManagerActivityHistoryModule.controller('SIScreeningManagerActivityActivityHistoryCtrl', function ($scope, $log, $controller, $timeout, $filter, UtilService, DateTimeConstants) {
        ...
        $controller('SIScreeningManagerActivityHistoryTableCtrl', {$scope: $scope});
    });

    SIScreeningManagerActivityHistoryModule.controller('SIScreeningManagerActivityHistoryTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, UtilService, NgTableParams,
                                                                                                               GeneralESService, DateTimeConstants) {
        $log.debug('SIScreeningManagerActivityHistoryTableCtrl');
