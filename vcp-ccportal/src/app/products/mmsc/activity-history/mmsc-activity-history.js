(function () {
    ...
    angular.module('ccportal.products.mmsc.activity-history', []);

    var MmscActivityHistoryModule = angular.module('ccportal.products.mmsc.activity-history');

    MmscActivityHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('products.mmsc.activity-history', {
            abstract: true,
            url: "/activity-history",
            templateUrl: "products/mmsc/activity-history/mmsc-activity-history.html"
        }).state('products.mmsc.activity-history.edr', {
            abstract: true,
            url: "",
            templateUrl: 'products/mmsc/activity-history/mmsc-activity-history.edr.html',
            controller: 'MmscActivityHistoryCtrl'
        }).state('products.mmsc.activity-history.edr.view', {
            url: "",
            views: {
                'permanentTable': {
    ...
    MmscActivityHistoryModule.controller('MmscActivityHistoryCtrl', function ($scope, $log, $q, $uibModal, $filter, $timeout, $controller, DateTimeConstants, GeneralESService,
                                                                              UtilService) {
        $log.debug('MmscActivityHistoryCtrl');
        ...
        $controller('MmscActivityHistoryPermanentCtrl', {$scope: $scope});
        $controller('MmscActivityHistoryTransientCtrl', {$scope: $scope});
        $controller('MmscActivityHistoryHistoryCtrl', {$scope: $scope});
        $controller('MmscActivityHistorySummarizeCtrl', {$scope: $scope});
    });

    MmscActivityHistoryModule.controller('MmscActivityHistoryPermanentCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants,
                                                                                       ReportingExportService, UtilService, GeneralESService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION) {
        $log.debug('MmscActivityHistoryPermanentCtrl');
    ...
    MmscActivityHistoryModule.controller('MmscActivityHistoryTransientCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, UtilService, DateTimeConstants,
                                                                                       ReportingExportService, GeneralESService, MmscTroubleshootingService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION) {
        $log.debug('MmscActivityHistoryTransientCtrl');
        ...
        $scope.mmscTransientEdrList.tableParams = new NgTableParams({
            ...
            getData: function ($defer, params) {
                ...
                GeneralESService.findMmscTransientEdrs(filter).then(function (response, additionalFilterFields) {
    ...
    MmscActivityHistoryModule.controller('MmscActivityHistoryHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants) {
        $log.debug('MmscActivityHistoryHistoryCtrl');
    ...
    MmscActivityHistoryModule.controller('MmscActivityHistorySummarizeCtrl', function ($scope, $log) {
        $log.debug('MmscActivityHistorySummarizeCtrl');
