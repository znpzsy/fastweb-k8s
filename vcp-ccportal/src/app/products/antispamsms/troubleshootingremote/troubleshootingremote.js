(function () {
    ...
    angular.module('ccportal.products.antispamsms.troubleshootingremote', []);

    var AntiSpamSMSTroubleshootingRemoteModule = angular.module('ccportal.products.antispamsms.troubleshootingremote');

    AntiSpamSMSTroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('products.antispamsms.troubleshootingremote', {
            abstract: true,
            url: "/troubleshooting-remote",
            templateUrl: "products/antispamsms/troubleshooting/troubleshooting.html"
        }).state('products.antispamsms.troubleshootingremote.edr', {
            abstract: true,
            url: "",
            templateUrl: 'products/antispamsms/troubleshooting/troubleshooting.edr.html',
            controller: 'AntiSpamSMSTroubleshootingRemoteCtrl'
        }).state('products.antispamsms.troubleshootingremote.edr.view', {
            url: "",
    ...
    AntiSpamSMSTroubleshootingRemoteModule.controller('AntiSpamSMSTroubleshootingRemoteCtrl', function ($scope, $log, $q, $filter, $controller, $timeout, notification, $translate, $uibModal, NgTableParams, ReportingExportService,
        ...
        $log.debug('AntiSpamSMSTroubleshootingRemoteCtrl');
        ...
        var exportEdrs = function (mimeType) {
            ...
            var bodyPayload = GeneralESService.prepareMainEdrQueryPayload(preparedFilter.filter, ['origMsisdn', 'destMsisdn'], 'date', preparedFilter.additionalFilterFields);
            var bodyPayloadStr = JSON.stringify(bodyPayload).replace(/\+/g, '%2b');

            var srcUrl = '/smsantispam-es-adapter-remote-rest/elastic-search-adapter/sms-as/_export';
        ...
        $scope.edrList.tableParams = new NgTableParams({
            ...
            getData: function ($defer, params) {
                ...
                GeneralESService.findSMSAntiSpamMainEdrsRemote(filter, additionalFilterFields).then(function (response) {
                ...
                resolve: {
                    ...
                    entireMsgContent: function ($q, $log, notification, $translate, GeneralESService) {
                        ...
                        if (s.toNumber(edrRecord.opPartTotal) === 1 || edrRecord.opPartTotal === null) {
                            ...
                            var promise = GeneralESService.findSMSAntiSpamMessagePartsRemote(edrRecord.origMsisdn, edrRecord.destMsisdn, edrRecord.opPartRef);
        ...
        $controller('AntiSpamSMSTroubleshootingRemoteHistoryCtrl', {$scope: $scope});
    });

    AntiSpamSMSTroubleshootingRemoteModule.controller('AntiSpamSMSTroubleshootingRemoteHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams) {
        $log.debug('AntiSpamSMSTroubleshootingRemoteHistoryCtrl');
            ...
            var modalInstance = $uibModal.open({
                ...
                resolve: {
                    smsAntiSpamEdrs: function (GeneralESService) {
                        return GeneralESService.findSMSAntiSpamHistoricalEdrsRemote(edrRecord.cdrKey);
                    },
                    edrRecord: function () {
                        return edrRecord;
                    },
